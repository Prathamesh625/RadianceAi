...
{ label: 'Patient Name', type: 'text', name: 'name', value: patient.name },
  { label: 'Age', type: 'number', name: 'age', value: patient.age , max:100 , min:10},
  { label: 'Contact No.', type: 'number', name: 'contact', value: patient.contact },
  ...
  return (
    <div className={styles.addPatientDetail}>
