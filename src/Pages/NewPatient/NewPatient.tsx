...
export const NewPatient = () => {
  ...
  console.log(localStorage.getItem("doctorId"))
    ...
    const onChangeHandler = (event:ChangeEvent<HTMLInputElement>) => {
      ...
      if (name === 'age' && value.length > 2) return alert('Age should be less than 100')
      if (name === 'contact' && value.length > 10) return alert('Contact should be of 10 digits')
  ...
  const onSubmitHandler = async (e) => {
    ...
    if(patient.name === "" || patient.age==="" || patient.contact==="" || patient.address==="")  return alert('All fields are compulsory')

    if (Object.keys(patient).length !== 7) return alert('All fields are compulsory')
  ...
  return (
    <div className={style.dashboard}>
      ...
      {/* Header component */}
        ...
        isFindDevice = {true}
          ...
          <section className={style.flexSection}>
            ...
            <NewPatientForm handleChange={onChangeHandler} patient={patient} onSubmit={onSubmitHandler} />
            ...
            />
                  ...
                  <div className={style.note}>
                     ...
                     <textarea   style={{resize:"none" ,width:"100%" , height:"70%" , outline:"none"}} placeholder='Add some note here if want to....'/>
                </div>
              <div className={style.proceed}>
                  <button className={style.proceedBtn} onClick={onSubmitHandler}>Proceed</button>  
                </div>
            </section>
     ...
     <Modal
        ...
        >
         <Flex gap={20}>
            <Progress percent={requestCompletion} showInfo={false} status='normal' strokeColor="rgba(87, 87, 237, 0.667);" />
