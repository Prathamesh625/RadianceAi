  ...
  return (
    <Document>
      ...
      <Page>
        <View style={styles.editor}>
          ...
          <Text>
            <Text style={styles.problem}>
              <Text style={styles.label}>Problem:</Text> {formData.problem}{' '}
            </Text>
          </Text>
        ...
        >
          <Text
            style={{ textAlign: 'center', fontSize: 15, marginTop: '20px' }}
          >
            RadianceAi
          </Text>
          <Text
            style={{ textAlign: 'center', fontSize: 12, marginTop: '10px' }}
          >
            Automatically generated by automated software of RadianceAi
          </Text>
        </View>
      </Page>
      :<Page></Page>
