...
const Header: React.FC<HeaderTypeDefination> = (props) => {
  ...
  const notify = () => {
    var message = toast.loading('Searching device to connect...', {
      duration: 4000,
    });
    ...
    return (
      ...
      >
        <input
          ...
          placeholder="Search task , appointments..."
        />
  ...
  return (
    ...
    <FileDownloadOutlined className={style.Icons} /> */}
      ...
      {isNotification && (
        <NotificationsOutlined className={style.Icons} onClick={showDrawer} />
      )}
